...
either weaken, grow, or hack. A 4tb server will run a little more than 2,000 threads.
   ...
   NOTE: _The server must be nuked and have backdoor for the script to work._ **AND** _Running too many threads can freeze the game up. Start low and incrase servers to see ho far you can safely go._
